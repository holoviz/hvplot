import pandas as pd
from hvplot.plotting import hvPlotTab
...
class TestOverrides(ComparisonTestCase):
    ...
    def test_define_default_options(self):
        hvplot = hvPlotTab(self.df, width=42, height=42)
        curve = hvplot(y='y')
    ...
    def test_define_custom_method(self):
        hvplot = hvPlotTab(self.df, {'custom_scatter': {'width': 42, 'height': 42}})
    ...
    def test_define_customize_method(self):
        hvplot = hvPlotTab(self.df, {'scatter': {'width': 42, 'height': 42}})
    ...
    def test_attempt_to_override_kind_on_method(self):
        hvplot = hvPlotTab(self.df, {'scatter': {'kind': 'line'}})

...
| Support | [![Discourse](https://img.shields.io/discourse/status?server=https%3A%2F%2Fdiscourse.holoviz.org)](https://discourse.holoviz.org/c/hvplot/8) | [Support]()
...
Check out [this blog post](https://towardsdatascience.com/the-easiest-way-to-create-an-interactive-dashboard-in-python-77440f2511d1) that describes how easy it is to create an interactive dashboard with hvPlot and Panel.
...
To get started check out the [Installation Instructions](#installation-instructions) and the [User Guide.](https://hvplot.holoviz.org/user_guide/index.html).
...
Please note that for versions of `jupyterlab<3.0`, you must also manually install the JupyterLab extension with:
